...
import {
    ...
    DateField,
    NumberField,
    Toolbar,     // Özel kaydetme butonu için
    SaveButton,  // Özel kaydetme butonu
    DeleteButton // Opsiyonel silme butonu
} from "react-admin";

// Özel bir Toolbar oluşturarak sadece Kaydet butonunu gösterebiliriz
// veya varsayılan Toolbar'ı kullanabiliriz (Kaydet ve Sil butonları olur)
