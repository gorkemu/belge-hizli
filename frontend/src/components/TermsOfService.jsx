  ...
  function TermsOfService() {
    ...
    const phone = "05530968833"; // Telefon numaranız buraya
  
    // Kaldırılan placeholder bilgileri: companyTitle, taxOffice, taxIdNumber, mersisNo, kepAddress
    ...
    return (
      <>
        ...
        <div className={styles.container}>
          ...
          <p className={styles.paragraph}>
            İşbu Sözleşme, bir tarafta merkezi {address} adresinde bulunan <strong>{ownerName}</strong> (bundan sonra "{siteName}" veya "Hizmet Sağlayıcı" olarak anılacaktır) ile diğer tarafta Site'yi kullanan veya Site üzerinden hizmet satın alan gerçek veya tüzel kişi ("Kullanıcı" veya "Müşteri") arasında akdedilmiştir.
          </p>
          ...
          <p className={styles.paragraph}>
            İşbu Mesafeli Satış Sözleşmesi ("Satış Sözleşmesi"), 6502 Sayılı Tüketicinin Korunması Hakkında Kanun ("Kanun") ve Mesafeli Sözleşmeler Yönetmeliği ("Yönetmelik") uygun olarak düzenlenmiştir.
          </p>
  
          <h4 className={styles.articleTitle}>MADDE 1: TARAFLAR</h4>
          <p className={styles.paragraph}><strong>SATICI:</strong></p>
          <ul className={styles.infoList}>
            <li>Unvan/Ad Soyad: {ownerName}</li> {/* Şahıs firması sahibi Ad Soyad */}
            <li>Adres: {address}</li>
            <li>Telefon: {phone}</li> {/* Telefon bilgisini ekledik */}
            <li>E-posta: {email}</li>
            {/* KEP, MERSİS, Vergi Dairesi, Vergi Kimlik No bilgileri kaldırıldı */}
          </ul>
